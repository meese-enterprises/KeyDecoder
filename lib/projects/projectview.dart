        ...
        child: Column(
          children: [
            ListTile(
              ...
              trailing: (project.pathCroppedPic.isEmpty)
                  ? null
                  : Image.file(File(project.pathCroppedPic)),
              isThreeLine: false,
              dense: true,
            ),
...
Widget projectStepper(Project project) {
  ...
  if (project.pathRawPic.isNotEmpty) curStep = 1;
  if (project.pathCroppedPic.isNotEmpty) curStep = 2;
  if (project.markers != null) curStep = 3;
