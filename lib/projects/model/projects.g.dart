...
class Project extends DataClass implements Insertable<Project> {
  ...
  factory Project.fromData(Map<String, dynamic> data, GeneratedDatabase db, {String prefix}) {
  ...
  factory Project.fromJsonString(String encodedJson, {ValueSerializer serializer}) =>
